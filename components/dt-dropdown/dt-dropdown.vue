<template>
  <view>
    <view @click="showShadow"
          class="dropWrap">{{ list[current] }}<view class="sanjiao"></view>
    </view>
    <view class="dropdown">
      <view :class="showIf ? 'dropdown-mask' : 'undropdown-mask'"
            @click="hideShadow"></view>
      ...
      <view class="ul"
        ...
        <view class="li"
              ...
              :key="index"
              @click="handlerItem(index)">{{ item }}</view>
      </view>
    </view>
  </view>
</template>

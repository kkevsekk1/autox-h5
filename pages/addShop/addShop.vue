<template>
	<view class="addShop_box">
		<button class="addBtn" @click="addShop" type="default">添加商铺</button>
		...
		<uni-popup ref="popup" type="center">
			<uni-forms :value="user" ref="form" :rules="rules" class="addshop">
				<uni-forms-item label="商铺名" name="name" required>
					<uni-easyinput type="text" v-model="user.name" placeholder="请输入商铺名" />
				</uni-forms-item>
				<uni-forms-item label="密码" name="password" required>
					<uni-easyinput type="password" v-model="user.password" placeholder="请输入密码" />
				</uni-forms-item>
				<uni-forms-item label="电话号码" name="account" required>
					<uni-easyinput type="text" v-model="user.account" placeholder="请输入电话号码" />
				</uni-forms-item>
